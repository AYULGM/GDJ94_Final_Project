        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item active">지출 통계</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link ${activeTab eq 'branch' ? 'active' : ''}" href="<c:url value='/statistics/expenses/by-branch'/>">
                            <i class="bi bi-building"></i> 지점별
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activeTab eq 'category' ? 'active' : ''}" href="<c:url value='/statistics/expenses/by-category'/>">
                            <i class="bi bi-tags"></i> 항목별
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${activeTab eq 'period' ? 'active' : ''}" href="<c:url value='/statistics/expenses/by-period'/>">
...
async function loadStatistics() {
    ...
    switch(activeTab) {
        case 'branch':
            apiUrl = '/statistics/api/expenses/by-branch';
            break;
        case 'category':
            apiUrl = '/statistics/api/expenses/by-category';
            break;
        case 'period':
            apiUrl = '/statistics/api/expenses/by-period';
            break;
    }
